  ...
  return (
    <ChakraProvider>
      <div className="App">
        ...
        <SignOut auth={auth} />
        <h1 className="h1WC">
          Trinity generates an image using AI based on <br></br>a specific
          prompt that includes 5 main keywords, then blurs it. <br></br>
          You try to guess the prompt used, and difficulty is reduced on each
          try. <br></br>
          Finally, you'll get the resulting image of the prompts you tried.{' '}
          <br></br>
          Good luck! <br></br>
        </h1>
